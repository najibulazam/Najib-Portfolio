...
export default function Education() {
  return (
    ...
    >
      <h2 className="text-4xl font-bold mb-6 text-cyan-400 text-center">Education</h2>

      <div className="space-y-8">
        {educationData.map((edu, idx) => (
          <article
            key={idx}
            className="flex flex-col sm:flex-row items-start sm:items-center gap-6 bg-gray-100 dark:bg-gray-800 rounded-lg p-6 shadow-md hover:shadow-cyan-500 transition"
          >
            <img
              src={edu.logo}
              alt={edu.institute}
