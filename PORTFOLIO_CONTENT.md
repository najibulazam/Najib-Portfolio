...
### 4. Full-Stack LMS
**Tech Stack:** Django REST, React, JWT, PostgreSQL

Complete Learning Management System with Django REST backend and React frontend. Implements role-based access control, JWT authentication, dynamic course management, and responsive user interface.

**GitHub:** https://github.com/najibulazam/Full-Stack-LMS-Learning-Management-System-with-Django-React

---

### 5. NextCircle Social Platform
**Tech Stack:** Django, REST API, PostgreSQL

Full-featured social networking application built with Django. Includes user authentication, real-time interactions, profile management, post filtering, and media handling with clean REST API architecture.

**GitHub:** https://github.com/najibulazam/NextCircle-Social-App

---

### 6. React Weather Dashboard
**Tech Stack:** React, Vite, REST API Integration

Modern weather application built with React and Vite. Features live weather data integration, responsive design, and intuitive user interface for real-time weather information.
...
**LinkedIn:** https://www.linkedin.com/in/najibulazam/  
**Location:** Bangladesh

---

## Call to Action
Looking for a Full Stack Developer with AI integration experience? Let's discuss how I can help bring your project to life.

---

## Key Positioning Points

- **Full Stack Developer** (NOT just Django or Backend)
- Strong Backend + API Engineer
- AI-integrated application builder
- Experienced with RAG, LLMs, and AI pipelines
